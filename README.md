...
This repo is configured to publish to GitHub Packages under the scope `@sojukrishna`.
...
```bash
npm install -g ./sojukrishna-opc-ua-modeler-0.1.0.tgz
opc-ua-modeler --port 5173
```
